...
func validateOlmAddon(ctx context.Context, t *testing.T, profile string) {
	...
	rr, err = Run(t, exec.CommandContext(ctx, Target(), "-p", profile, "addons", "disable", "olm", "--alsologtostderr", "-v=1"))
	if err != nil {
...
func validateHeadlampAddon(ctx context.Context, t *testing.T, profile string) {
	...
	rr, err = Run(t, exec.CommandContext(ctx, Target(), "-p", profile, "addons", "disable", "headlamp", "--alsologtostderr", "-v=1"))
	if err != nil {
...
func validateYakdAddon(ctx context.Context, t *testing.T, profile string) {
	...
	rr, err = Run(t, exec.CommandContext(ctx, Target(), "-p", profile, "addons", "disable", "yakd", "--alsologtostderr", "-v=1"))
	if err != nil {
